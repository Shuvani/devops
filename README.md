...
```
open http://0.0.0.0:8000/v5.0.0/ in the browser

## Getting started with Docker
```
docker pull shuvani/moscow_time:5.0.0 // to update the version
docker run -p 8000:8000 shuvani/moscow_time:5.0.0
```
open http://0.0.0.0:8000/v5.0.0/ in the browser
